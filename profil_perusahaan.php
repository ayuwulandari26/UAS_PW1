...
<body>
    ...
    <div class="container">
        <h1 style="margin-bottom: 20px;">PROFIL SENJA</h1>
        <table class="table table-striped">
          <tbody>
            <tr class="text-center">
              <td><img src="img/profil%20perusahaan.jpg" width="800px" height="500px"></td>
            </tr>
            <tr>
              <td class="text-center">Senja adalah sebuah perusahaan baru yang didirikan sejak tahun 2021 dan buka 24 jam secara online. <br>
              Kami sadar bahwa minat membaca rakyat Indonesia tergolong rendah, sehingga kami datang membantu untuk meningkatkan minat membaca. Dengan sistem yang kami buat sedemikian rupa, pembaca akan merasa nyaman dan betah untuk membaca berjam-jam serta mendapatkan pengalaman membaca yang luar biasa, ilmu yang didapat pun akan semakin banyak. Maka dari itu mari bangun kebiasaan itu dengan mulai dengan membaca di Senja.</td>
            </tr>
          </tbody>
        </table>
    </div>
